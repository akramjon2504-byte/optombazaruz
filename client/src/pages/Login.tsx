      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            {language === 'uz' 
              ? 'OptomBazar.uz hisobingizga kiring' 
              : 'Войдите в свой аккаунт OptomBazar.uz'}
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder={language === 'uz' ? 'email@example.com' : 'email@example.com'}
                  className="pl-10"
                  {...form.register('email')}
          ...
          >
            ...
            Google {language === 'uz' ? 'orqali kirish' : 'войти'}
          </Button>
